...
Revision ID: 0b6d5a6371f6
Revises: 
Create Date: 2019-06-14 13:30:25.675534
...
def upgrade():
    ...
    sa.Column('license_type', sa.Enum('STARTER', 'PROFESSIONAL', 'BUSINESS', name='licensetype'), nullable=True),
